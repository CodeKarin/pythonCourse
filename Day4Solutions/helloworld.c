...
static const char __pyx_k_Created_on_Fri_Mar_4_11_25_00_2[] = "\nCreated on Fri Mar  4 11:25:00 2022\n\n@author: karwe916\n";
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "helloworld",
    __pyx_k_Created_on_Fri_Mar_4_11_25_00_2, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("helloworld", __pyx_methods, __pyx_k_Created_on_Fri_Mar_4_11_25_00_2, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
